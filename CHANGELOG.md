...
- Replaced Small Benchmark with somatic somall and germline small benchmark subworkflows: Added Aardvark as a evaluation method within the SMALL_BENCHMARK workflow, alongside Hap.py, Sompy, and RTGtools for both germline and somatic tracks [#315](https://github.com/nf-core/variantbenchmarking/issues/315).
